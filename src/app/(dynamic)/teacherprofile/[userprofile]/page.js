                      ...
                      <div className='flex flex-col gap-2'>
                        ...
                        <div className='flex justify-between items-center text-sm text-gray-600 gap-2'>
                          ...
                          <Link href={`/teacherprofile/${item.userId}`}>
                            <div className='flex items-center gap-1 '>
                              <svg class="w-3 h-3 text-gray-800 fill-purple-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
