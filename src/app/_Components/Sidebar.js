...
const Sidebar = () => {
    ...
    return (
        <>
            <div className='sticky font-[Poppins] h-screen hover:text-[#d42eeb] z-20'>
                <aside id="logo-sidebar" className=" left-0 z-40 w-64 h-screen bg-white border-r border-gray-200 pt-8 transition-transform -translate-x-full bg-white  lg:translate-x-0 fixed top-[64px] lg:sticky lg:block dark:border-gray-700" aria-label="Sidebar">
                    <div className="h-full px-3 pb-4 relative overflow-y-auto bg-white ">
                        <ul className="space-y-2 font-medium">
                            ...
                            <li className='group'>
                                <Link href="/courses" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                                    <svg className="w-5 h-5 group-hover:fill-[#d42eeb] group-hover:text-[#d42eeb] text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <li className='group'>
                                <Link href="/stdashboard/updatesbytutor" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                                    <svg className="w-5 h-5 group-hover:fill-[#d42eeb] group-hover:text-[#d42eeb] text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <li className='group'>
                                ...
                                <svg class="w-5 h-5 group-hover:fill-[#d42eeb] group-hover:text-[#d42eeb] text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
                            ...
                            <div className='absolute h-fit bottom-20'>
                                <li>
                                    <Link  href="/profile" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group cursor-pointer">
                                ...
                                <li>
                                    <a onClick={() => setIsModalOpen(true)} href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group cursor-pointer">
                                        <svg className="w-5 h-5 text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            {isModalOpen && (
                <div className="fixed z-50 inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-full mx-2 md:w-1/3">
