      ...
      <p  className="text-white text-sm font-medium font-[Poppins] ">suggestion based on your interest</p>
        ...
        <div className='flex gap-4 mt-5 justify-center items-center'>
          {data.length>0?<div className='w-full overflow-auto md:overflow-x-auto'>
            ...
            <div className='flex overflow-auto sm:flex-row gap-4 pl-4 pr-4 pb-3'>
              {data.map((item, idx) => (
                <Link key={idx} href={`/courses/${item.courseId}/${item?.videosrc[0]?._id}`}  className='cursor-pointer' >
                  ...
                  <motion.div
                    ...
                    className="rounded-lg  overflow-hidden shadow-md border border-gray-200 max-w-sm w-[200px] h-[250px] sm:w-[300px] sm:h-fit lg:w-[350px]"
                  >
                    ...
                    <div className='p-5'>
                      <div className='flex flex-col gap-2'>
                        <div className='flex items-center justify-between'>
                          ...
                          <h5 className=" font-bold text-[#d42eeb] truncate sm:text-[18px] text-[12px] capitalize">{item?.courseName}</h5>
                          ...
                          <ul className='flex'>

                            {
                              [1, 2, 3, 4, 5].map((items,idx) => (
                                <svg key={idx} className="sm:w-4 sm:h-4 w-3 h-3  fill-yellow-500 text-yellow-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <div className='flex justify-between items-center text-sm text-gray-600 gap-2'>
                          ...
                          <Link href={`/teacherprofile/${item.userId}`}>
                            <div className='flex gap-1 '>
                              <svg class="w-5 h-5 text-gray-800 fill-purple-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
